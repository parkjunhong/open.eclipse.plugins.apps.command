...
//			objClass = obj.getClass();
	...
	public static IResource getResource(Object obj) {
		...
		try {
			...
			// (begin) patch for PyDev 3.3.3
			else if (IWrappedResource.class.isAssignableFrom(objClass)) {
				IWrappedResource pydevResource = (IWrappedResource) obj;
				resource = (IResource) pydevResource.getActualObject();
			}
			// (end) patch for PyDev 3.3.3
			else {
